...
export default async function DashboardHomePage() {
  ...
  const enrollmentStatusLabel = canInscribeStudents
    ? copy.enrollmentEnabledLabel
    : copy.enrollmentRestrictedLabel;
  ...
  return (
    <section className="landing-panel animate-fade-in-up relative overflow-hidden rounded-3xl border border-primary/20 bg-card/96 p-6 shadow-xl shadow-primary/10 sm:p-8">
